        ...
        for (int i = 0; i < numLines; i++) {
            ...
            for (int j = 0; j < children; j++) {
                ...
                if (lp.height == LayoutParams.MATCH_PARENT) {
                    ...
                    child.measure(MeasureSpec.makeMeasureSpec(childWidthSize, childWidthMode), MeasureSpec.makeMeasureSpec(lineHeight - lp.topMargin - lp.bottomMargin, MeasureSpec.EXACTLY));
                }
