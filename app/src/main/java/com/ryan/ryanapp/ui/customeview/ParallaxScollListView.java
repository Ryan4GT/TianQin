...
public class ParallaxScollListView extends ListView implements OnScrollListener {
    ...
    public ParallaxScollListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(Context context) {
        mDefaultImageViewHeight = context.getResources().getDimensionPixelSize(R.dimen._160dp);
    }
